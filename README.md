...
ddev config --project-type=typo3 --docroot=Build/public --php-version=8.5
...
├── Build/                        # Core's own build tooling, PLUS the instance:
│   ├── public/                   #   the docroot (--docroot=Build/public)
